...
public class TestBoard extends TestCase {
	...
	public void testBoard(){
		...
		/*
		Square sq1 = m.getCurrentLevel().getBoard().getSquare(0, 0);
		Square sq2 = m.getCurrentLevel().getBoard().getSquare(1, 0);
		Square sq3 = m.getCurrentLevel().getBoard().getSquare(2, 0);
